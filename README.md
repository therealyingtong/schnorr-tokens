...
- A Noir circuit for signature verification in [`verifier/src/schnorr_token.nr`](https://github.com/therealyingtong/schnorr-tokens/blob/main/verifier/src/schnorr_token.nr).
